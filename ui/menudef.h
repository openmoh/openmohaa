...
#define ITEM_ALIGN_CENTERX 1              // center (X axis) alignment
#define ITEM_ALIGN_RIGHT 2                // right alignment
#define ITEM_ALIGN_TOP 3                  // top alignment
#define ITEM_ALIGN_BOTTOM 4               // bottom alignment
#define ITEM_ALIGN_CENTERY 5              // center (Y axis) alignment
