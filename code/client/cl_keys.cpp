...
===================
*/
void Field_VariableSizeDraw(fontInfo_t *font, field_t *edit, int x, int y, int width, qboolean showCursor,
...
{
	Field_VariableSizeDraw(font, edit, x, y, width, showCursor, noColorEscape );
}
