...
private:
    ...
    void
    Initialize(const char *root_directory, const char *current_directory, const char *ext, const char *ignore_files);
...
public:
    ...
    void
    Setup(const char *root_directory, const char *current_directory, const char *ext, const char *ignore_files = NULL);
};
